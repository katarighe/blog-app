...
fourth_user = User.create(name: 'Alan', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Singer from Australia.')
...
fifth_post = Post.create(author: second_user, title: 'I am from England', text: "This is another person's post")
...
Comment.create(post: first_post, user: second_user, text: 'I am a teacher too!')
...
Comment.create(post: first_post, user: third_user, text: 'I am from Mexico too!')